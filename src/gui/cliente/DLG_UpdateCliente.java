 ...
 * @author rosal
 */
public class DLG_UpdateCliente extends javax.swing.JDialog implements Runnable {

    Administrador a;

    /**
     * Creates new form DLG_UpdateCliente
     */
    public DLG_UpdateCliente(java.awt.Frame parent, boolean modal, Administrador a) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBoxCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 252, -1));
        ...
        jLabel5.setText("ID");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 30, 20));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 450));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int id = jComboBoxCliente.getItemAt(jComboBoxCliente.getSelectedIndex()).getId();
        String nombre = jTextFieldNombre.getText();
        String apellido = jTextFieldApellido.getText();

        DAO_Cliente dao = new DAO_Cliente();
        dao.updateCliente(new Cliente(id, nombre, apellido), a);
