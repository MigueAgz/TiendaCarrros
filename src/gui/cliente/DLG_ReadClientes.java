 ...
 * @author rosal
 */
public class DLG_ReadClientes extends javax.swing.JDialog implements Runnable {

    /**
     * Creates new form DLG_ReadClientes
     */
    public DLG_ReadClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 330, 270));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 350, 60));
    ...
    @Override
    public void run() {
        jTable1.setModel(new DAO_Cliente().tablaClientes());
    }
}
